...
export var Wrapper_TextInput = (function () {
    function Wrapper_TextInput(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9) {
        ...
        this._clearOnEdit = import1.UNINITIALIZED;
    ...
    Wrapper_TextInput.prototype.check_clearOnEdit = function (currValue, throwOnChange, forceUpdate) {
        if ((forceUpdate || import2.checkBinding(throwOnChange, this._clearOnEdit, currValue))) {
            this.changed = true;
            this.context.clearOnEdit = currValue;
            this._clearOnEdit = currValue;
        }
    };
...
var _View_TextInput0 = (function (_super) {
    ...
    _View_TextInput0.prototype.createInternal = function (rootSelector) {
        ...
        var disposable_4 = this.renderer.listen(this._el_0, 'keydown', this.eventHandler(this._handle_keydown_0_4.bind(this)));
        ...
        var subscription_1 = this._NativeInput_0_9.context.keydown.subscribe(this.eventHandler(this._handle_keydown_0_4.bind(this)));
        this._expr_23 = import1.UNINITIALIZED;
        var disposable_5 = this.renderer.listen(this._el_2, 'click', this.eventHandler(this._handle_click_2_0.bind(this)));
        var disposable_6 = this.renderer.listen(this._el_2, 'mousedown', this.eventHandler(this._handle_mousedown_2_1.bind(this)));
    ...
    _View_TextInput0.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_11 = 'text-input';
        this._NgClass_0_3.check_klass(currVal_11, throwOnChange, false);
        var currVal_12 = ('text-input-' + this.context._mode);
        this._NgClass_0_3.check_ngClass(currVal_12, throwOnChange, false);
        ...
        this._NgModel_0_6.check_model(currVal_13, throwOnChange, false);
        ...
        var currVal_20 = this.context._useAssist;
        this._NgIf_1_6.check_ngIf(currVal_20, throwOnChange, false);
        this._NgIf_1_6.detectChangesInternal(this, this._anchor_1, throwOnChange);
        var currVal_24 = '';
        this._Button_2_4.check_clear(currVal_24, throwOnChange, false);
        if (this._Button_2_4.detectChangesInternal(this, this._el_2, throwOnChange)) {
            this._appEl_2.componentView.markAsCheckOnce();
        }
        var currVal_25 = this.context._useAssist;
        this._NgIf_3_6.check_ngIf(currVal_25, throwOnChange, false);
        ...
        var currVal_9 = this.context.type;
        if (import2.checkBinding(throwOnChange, this._expr_9, currVal_9)) {
            this.renderer.setElementProperty(this._el_0, 'type', currVal_9);
            this._expr_9 = currVal_9;
        }
        var currVal_10 = this.context.placeholder;
        if (import2.checkBinding(throwOnChange, this._expr_10, currVal_10)) {
            this.renderer.setElementProperty(this._el_0, 'placeholder', currVal_10);
            this._expr_10 = currVal_10;
        }
        var currVal_14 = this._NgControlStatus_0_8.context.ngClassUntouched;
        if (import2.checkBinding(throwOnChange, this._expr_14, currVal_14)) {
            this.renderer.setElementClass(this._el_0, 'ng-untouched', currVal_14);
            this._expr_14 = currVal_14;
        }
        var currVal_15 = this._NgControlStatus_0_8.context.ngClassTouched;
        if (import2.checkBinding(throwOnChange, this._expr_15, currVal_15)) {
            this.renderer.setElementClass(this._el_0, 'ng-touched', currVal_15);
            this._expr_15 = currVal_15;
        }
        var currVal_16 = this._NgControlStatus_0_8.context.ngClassPristine;
        if (import2.checkBinding(throwOnChange, this._expr_16, currVal_16)) {
            this.renderer.setElementClass(this._el_0, 'ng-pristine', currVal_16);
            this._expr_16 = currVal_16;
        }
        var currVal_17 = this._NgControlStatus_0_8.context.ngClassDirty;
        if (import2.checkBinding(throwOnChange, this._expr_17, currVal_17)) {
            this.renderer.setElementClass(this._el_0, 'ng-dirty', currVal_17);
            this._expr_17 = currVal_17;
        }
        var currVal_18 = this._NgControlStatus_0_8.context.ngClassValid;
        if (import2.checkBinding(throwOnChange, this._expr_18, currVal_18)) {
            this.renderer.setElementClass(this._el_0, 'ng-valid', currVal_18);
            this._expr_18 = currVal_18;
        }
        var currVal_19 = this._NgControlStatus_0_8.context.ngClassInvalid;
        if (import2.checkBinding(throwOnChange, this._expr_19, currVal_19)) {
            this.renderer.setElementClass(this._el_0, 'ng-invalid', currVal_19);
    ...
    _View_TextInput0.prototype._handle_keydown_0_4 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._NativeInput_0_9.context._keyDown($event) !== false);
        return (true && pd_0);
    };
...
var _View_TextArea0 = (function (_super) {
    ...
    _View_TextArea0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        this._NgIf_1_6.detectChangesInternal(this, this._anchor_1, throwOnChange);
        var currVal_20 = this.context._useAssist;
        this._NgIf_2_6.check_ngIf(currVal_20, throwOnChange, false);
    ...
    _View_TextArea0.prototype._handle_keydown_0_4 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._NativeInput_0_9.context._keyDown($event) !== false);
        return (true && pd_0);
    };
