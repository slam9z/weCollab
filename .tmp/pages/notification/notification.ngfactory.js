...
import * as import0 from './notification';
...
export var Wrapper_NotificationPage = (function () {
    function Wrapper_NotificationPage(p0) {
        this.changed = false;
        this.context = new import0.NotificationPage(p0);
    }
    Wrapper_NotificationPage.prototype.detectChangesInternal = function (view, el, throwOnChange) {
        var changed = this.changed;
        this.changed = false;
        return changed;
    };
    return Wrapper_NotificationPage;
}());
var renderType_NotificationPage_Host = null;
var _View_NotificationPage_Host0 = (function (_super) {
    __extends(_View_NotificationPage_Host0, _super);
    function _View_NotificationPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_NotificationPage_Host0, renderType_NotificationPage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_NotificationPage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-notification', rootSelector, null);
        this._appEl_0 = new import3.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_NotificationPage0(this.viewUtils, this.injector(0), this._appEl_0);
        this._NotificationPage_0_4 = new Wrapper_NotificationPage(this.parentInjector.get(import8.NavController));
        this._appEl_0.initComponent(this._NotificationPage_0_4.context, [], compView_0);
        compView_0.create(this._NotificationPage_0_4.context, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_NotificationPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.NotificationPage) && (0 === requestNodeIndex))) {
            return this._NotificationPage_0_4.context;
        }
        return notFoundResult;
    };
    _View_NotificationPage_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._NotificationPage_0_4.detectChangesInternal(this, this._el_0, throwOnChange);
        this.detectContentChildrenChanges(throwOnChange);
        this.detectViewChildrenChanges(throwOnChange);
    };
    return _View_NotificationPage_Host0;
}(import1.AppView));
function viewFactory_NotificationPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_NotificationPage_Host === null)) {
        (renderType_NotificationPage_Host = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, [], {}));
    }
    return new _View_NotificationPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var NotificationPageNgFactory = new import10.ComponentFactory('page-notification', viewFactory_NotificationPage_Host0, import0.NotificationPage);
var styles_NotificationPage = [];
var renderType_NotificationPage = null;
var _View_NotificationPage0 = (function (_super) {
    __extends(_View_NotificationPage0, _super);
    function _View_NotificationPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_NotificationPage0, renderType_NotificationPage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_NotificationPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_6 = this.renderer.createText(null, 'Notification', null);
    ...
    _View_NotificationPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_NotificationPage0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    _View_NotificationPage0.prototype.destroyInternal = function () {
        this._Content_10_4.context.ngOnDestroy();
    };
    return _View_NotificationPage0;
}(import1.AppView));
export function viewFactory_NotificationPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_NotificationPage === null)) {
        (renderType_NotificationPage = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, styles_NotificationPage, {}));
    }
    return new _View_NotificationPage0(viewUtils, parentInjector, declarationEl);
}
//# sourceMappingURL=notification.ngfactory.js.map