...
export var Wrapper_MePage = (function () {
    function Wrapper_MePage(p0) {
        this.changed = false;
        this.context = new import0.MePage(p0);
    }
    Wrapper_MePage.prototype.detectChangesInternal = function (view, el, throwOnChange) {
        var changed = this.changed;
        this.changed = false;
        return changed;
    };
    return Wrapper_MePage;
}());
...
var _View_MePage_Host0 = (function (_super) {
    ...
    _View_MePage_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_0.initComponent(this._MePage_0_4.context, [], compView_0);
        compView_0.create(this._MePage_0_4.context, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_MePage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.MePage) && (0 === requestNodeIndex))) {
            return this._MePage_0_4.context;
        }
        return notFoundResult;
    };
    _View_MePage_Host0.prototype.detectChangesInternal = function (throwOnChange) {
...
export var MePageNgFactory = new import10.ComponentFactory('page-me', viewFactory_MePage_Host0, import0.MePage);
var styles_MePage = [];
...
var _View_MePage0 = (function (_super) {
    ...
    _View_MePage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_6 = this.renderer.createText(null, 'Me', null);
...
export function viewFactory_MePage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MePage === null)) {
        (renderType_MePage = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, styles_MePage, {}));
    }
    return new _View_MePage0(viewUtils, parentInjector, declarationEl);
}
//# sourceMappingURL=me.ngfactory.js.map